...
animal_type = st.sidebar.selectbox("What is your pet?", ("Dog", "Cat", "Hamster", "Rat", "Snake", "Lizard", "Cow", "Goat"))
...
with st.sidebar:
    ...
    "[View the original source code](https://github.com/rishabkumar7/pets-name-langchain/tree/main)"
